...
MODEL           = ReadAnalogInput
MODULES         = ReadAnalogInput_capi.c ReadAnalogInput_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = ReadAnalogInput.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Dropbox\STEWAR~1\Matlab\Control\2013_0~1
S_FUNCTIONS     = addiamondmm16atcustom.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = ReadAnalogInputlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ReadAnalogInput_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\ReadAnalogInput_xpc_rtw
