...
MODEL           = GUI_User_V1_3
MODULES         = GUI_User_V1_3_capi.c GUI_User_V1_3_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = GUI_User_V1_3.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Dropbox\Stewart-Gough\Matlab\Control\GUI_V3\Code2XPCtarget
S_FUNCTIONS     = xpcfromfile.c fifowrite.c fiforead.c addiamondmm16atcustom.c asciiencode.c sersetupbase.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f C:\Users\LAB_ME~1\AppData\Roaming\MATHWO~1\MATLAB\R2011a\mexopts.bat
...
MODELLIB                  = GUI_User_V1_3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = GUI_User_V1_3_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\GUI_User_V1_3_xpc_rtw
