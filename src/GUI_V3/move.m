function [d,id_PWM]=move( X,Y,Z,Roll,Pitch,Yaw)
...
%id_PWM = [222; 223; 224; 225; 226; 227];
...
for j=1:6
    tgPC104.setparam(id_PWM(j),d(j));      %set_param('GUI_User_V1_3/If Action Subsystem5/Set1','ActLen',['[',num2str(d'),']']);
end
