function [ aPb,aRb,aVp,aWb,aVpP,aWbP,Angles,time ] = Circle_Primitive (circle,iniZ,tmpIniAngle,finalZ,tmpFinalAngle,Time,samTime)
%CIRCLE_PRIMITIVE Summary of this function goes here
%   Detailed explanation goes here

[z,time] = Quintic_Inter(iniZ,0,0,0,finalZ,0,0,Time,samTime);
[x, y , time ] = PolarCircle(circle(1),circle(2),circle(3),circle(4),circle(5),Time,samTime);
